...
class GeneralPanel : public ModelPanel
{
    Q_OBJECT

  public:
    GeneralPanel(QWidget *parent, ModelData & model, GeneralSettings & generalSettings, Firmware * firmware, CompoundItemModelFactory * sharedItemModels);
